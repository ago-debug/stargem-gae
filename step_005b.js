    ...
    await db.transaction(async (tx) => {
      ...
      for (const row of members1) {
        ...
        await tx.execute(sql`
          INSERT INTO memberships (member_id, membership_number, barcode, season_id, status, membership_type, issue_date, notes, data_quality_flag)
          VALUES (${row.member_id}, ${mNum}, ${mNum}, 1, 'active', 'ENDAS', ${row.enrollment_date}, 'importato da bonifica storico Chat22b', 'da_verificare');
        `);
        insertedOp1++;
      }
