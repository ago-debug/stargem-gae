...
export function InlineListEditor({ listCode, listName, showColors = false }: InlineListEditorProps) {
  ...
  return (
    <div className="flex flex-col gap-3 p-2 w-72 max-h-[var(--radix-popover-content-available-height)]">
      ...
      <div className="flex flex-col gap-1 mt-2 overflow-y-auto pr-1 flex-1 min-h-0">
