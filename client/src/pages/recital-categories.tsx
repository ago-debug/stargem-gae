...
import type { RecitalCategory, InsertRecitalCategory } from "@shared/schema";

export default function RecitalCategories() {
  const { toast } = useToast();
  const [isFormOpen, setIsFormOpen] = useState(false);
  const [editingCategory, setEditingCategory] = useState<RecitalCategory | null>(null);

  const { data: categories, isLoading } = useQuery<RecitalCategory[]>({
    queryKey: ["/api/recital-categories"],
  });

  const createMutation = useMutation({
    mutationFn: async (data: InsertRecitalCategory) => {
      await apiRequest("POST", "/api/recital-categories", data);
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["/api/recital-categories"] });
  ...
  const updateMutation = useMutation({
    mutationFn: async ({ id, data }: { id: number; data: InsertRecitalCategory }) => {
      await apiRequest("PATCH", `/api/recital-categories/${id}`, data);
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["/api/recital-categories"] });
  ...
  const deleteMutation = useMutation({
    mutationFn: async (id: number) => {
      await apiRequest("DELETE", `/api/recital-categories/${id}`, undefined);
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["/api/recital-categories"] });
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const data: InsertRecitalCategory = {
    ...
    <div className="p-6 md:p-8 space-y-8 max-w-7xl mx-auto">
      <div className="flex items-center justify-between gap-4 flex-wrap">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-semibold text-foreground" data-testid="text-page-title">Categorie Saggi e Spettacoli</h1>
            <p className="text-muted-foreground text-sm">Organizza i saggi e spettacoli per categorie e sottocategorie</p>
          </div>
        </div>
        <Button
          onClick={() => {
          ...
          data-testid="button-add-recital-category"
        >
      ...
      <Card className="border-border/60 shadow-sm">
        <CardHeader className="border-b border-border/40 pb-4">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-lg font-bold">Struttura Categorie Saggi e Spettacoli</h2>
          </div>
        </CardHeader>
                  ...
                  <div className="flex items-center justify-between p-3 rounded-md border border-border/50 hover:bg-muted/40 transition-colors">
                    ...
                    <div className="flex items-center gap-2 flex-shrink-0 ml-4">
                      <Button
                        ...
                        data-testid={`button-edit-recital-category-${category.id}`}
                      >
                      ...
                      <Button
                        ...
                        data-testid={`button-delete-recital-category-${category.id}`}
                      >
                        ...
                        >
                          ...
                          <div className="flex items-center gap-2 flex-shrink-0 ml-4">
                            <Button
                              ...
                              data-testid={`button-edit-recital-category-${child.id}`}
                            >
                            ...
                            <Button
                              ...
                              data-testid={`button-delete-recital-category-${child.id}`}
                            >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                required
                data-testid="input-recital-category-name"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                rows={3}
                data-testid="input-recital-category-description"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Select name="parentId" defaultValue={editingCategory?.parentId?.toString() || "none"}>
                <SelectTrigger data-testid="select-recital-category-parent">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                data-testid="input-recital-category-color"
              />
            </div>
            ...
            <DialogFooter>
              <Button
                ...
                data-testid="button-cancel-recital-category"
              >
                Annulla
              </Button>
              <Button
                ...
                data-testid="button-submit-recital-category"
              >
