    ...
    <div className="p-4 space-y-4">
      <div className="flex items-center justify-between gap-4 flex-wrap">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-semibold text-foreground" data-testid="text-page-title">Categorie Saggi</h1>
            <p className="text-muted-foreground text-sm">Organizza i saggi per categorie e sottocategorie</p>
          </div>
        </div>
        <Button 
          onClick={() => {
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-lg font-medium">Struttura Categorie Saggi</h2>
          </div>
        </CardHeader>
        <CardContent>
          {isLoading ? (
