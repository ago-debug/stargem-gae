  ...
  return (
    <div className="p-6 md:p-8 space-y-6 max-w-7xl mx-auto">
      ...
      <div className="flex items-center justify-between gap-4 flex-wrap">
        <div>
          <h1 className="text-3xl font-semibold text-foreground mb-2" data-testid="text-page-title">Categorie Saggi</h1>
          <p className="text-muted-foreground">Organizza i saggi per categorie e sottocategorie</p>
        </div>
        <Button 
          onClick={() => {
            setEditingCategory(null);
