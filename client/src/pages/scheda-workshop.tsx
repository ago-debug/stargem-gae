        ...
        return (
            <div className="p-6 md:p-8 max-w-7xl mx-auto">
                <div className="bg-white p-6 rounded-xl border shadow-sm">
                    <h1 className="text-2xl font-bold text-slate-800">Scheda Workshop</h1>
                    <p className="text-slate-600 mt-2">Parametro <code>workshopId</code> mancante o non valido nell’URL.</p>
                    <div className="mt-4">
    ...
    if (!workshop) {
        return (
            <div className="p-6 md:p-8 max-w-7xl mx-auto">
                <div className="bg-white p-6 rounded-xl border shadow-sm">
                    <h1 className="text-2xl font-bold text-slate-800">Scheda Workshop</h1>
                    <p className="text-slate-600 mt-2">Workshop non trovato per <code>workshopId={String(workshopId)}</code>.</p>
                    <div className="mt-4">
                        <Button variant="outline" onClick={() => setLocation("/iscritti_per_attivita")}>
                            Torna a Iscritti per Attività
                        </Button>
