...
import type { IndividualLesson, Member, Enrollment, Payment, Attendance } from "@shared/schema";
...
export default function SchedaLezioneIndividuale() {
    ...
    const { data: items, isLoading: itemsLoading } = useQuery<IndividualLesson[]>({ queryKey: ["/api/individual-lessons"] });
