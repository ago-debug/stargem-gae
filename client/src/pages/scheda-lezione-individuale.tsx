...
export default function SchedaLezioneIndividuale() {
        ...
        return (
            <div className="p-6 md:p-8 mx-auto">
                <div className="bg-background p-6 rounded-xl border shadow-sm">
                    <h1 className="text-2xl font-bold text-foreground">Scheda Lezione Individuale</h1>
    ...
    const attendancesCount = enrolledMembersData.reduce((acc: number, curr: any) => acc + (Number(curr.presenze_count) || 0), 0);
