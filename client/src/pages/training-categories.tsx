...
import type { TrainingCategory, InsertTrainingCategory } from "@shared/schema";
...
export default function TrainingCategories() {
  ...
  const { data: categories, isLoading } = useQuery<TrainingCategory[]>({
    queryKey: ["/api/training-categories"],
  });

  const createMutation = useMutation({
    mutationFn: async (data: InsertTrainingCategory) => {
      await apiRequest("POST", "/api/training-categories", data);
    },
    onSuccess: () => {
  ...
  const updateMutation = useMutation({
    mutationFn: async ({ id, data }: { id: number; data: InsertTrainingCategory }) => {
      await apiRequest("PATCH", `/api/training-categories/${id}`, data);
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["/api/training-categories"] });
  ...
  const deleteMutation = useMutation({
    mutationFn: async (id: number) => {
      await apiRequest("DELETE", `/api/training-categories/${id}`, undefined);
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["/api/training-categories"] });
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const data: InsertTrainingCategory = {
  ...
  return (
    <div className="p-6 md:p-8 space-y-6 max-w-7xl mx-auto">
      ...
      <div className="flex items-center justify-between gap-4 flex-wrap">
        <div>
          <h1 className="text-3xl font-semibold text-foreground mb-2" data-testid="text-page-title">Categorie Allenamenti/Affitti</h1>
          <p className="text-muted-foreground">Organizza gli allenamenti e affitti per categorie e sottocategorie</p>
        </div>
        <Button 
          onClick={() => {
            setEditingCategory(null);
          ...
          data-testid="button-add-training-category"
        >
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-lg font-medium">Struttura Categorie Allenamenti/Affitti</h2>
          </div>
        </CardHeader>
        <CardContent>
          {isLoading ? (
                  ...
                  <div className="flex items-center justify-between p-3 rounded-md hover-elevate active-elevate-2 border border-border">
                    ...
                    <div className="flex items-center gap-2 flex-shrink-0 ml-4">
                      <Button
                        ...
                        data-testid={`button-edit-training-category-${category.id}`}
                      >
                      ...
                      <Button
                        ...
                        data-testid={`button-delete-training-category-${category.id}`}
                      >
                        ...
                        >
                          ...
                          <div className="flex items-center gap-2 flex-shrink-0 ml-4">
                            <Button
                              ...
                              data-testid={`button-edit-training-category-${child.id}`}
                            >
                              <Edit className="w-4 h-4" />
                            </Button>
                            <Button
                              ...
                              data-testid={`button-delete-training-category-${child.id}`}
                            >
                              <Trash2 className="w-4 h-4" />
                            </Button>
                          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                required
                data-testid="input-training-category-name"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                rows={3}
                data-testid="input-training-category-description"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Select name="parentId" defaultValue={editingCategory?.parentId?.toString() || "none"}>
                <SelectTrigger data-testid="select-training-category-parent">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                data-testid="input-training-category-color"
              />
            </div>
            ...
            <DialogFooter>
              <Button
                ...
                data-testid="button-cancel-training-category"
              >
                Annulla
              </Button>
              <Button 
                ...
                data-testid="button-submit-training-category"
              >
