    ...
    <div className="p-4 space-y-4">
      <div className="flex items-center justify-between gap-4 flex-wrap">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-semibold text-foreground">Gestione Pagamenti</h1>
            <p className="text-muted-foreground text-sm">Traccia pagamenti, quote e incassi</p>
          </div>
        </div>
