        ...
        <CardContent>
          {isLoading ? (
            ...
            <div className="text-center py-16 px-4 bg-muted/50 border border-dashed border-border rounded-2xl animate-in fade-in zoom-in-95 duration-500 m-4 flex flex-col items-center justify-center">
              ...
              <p className="text-xl font-bold tracking-tight text-foreground mb-1">Nessun pagamento trovato</p>
              <p className="text-sm text-muted-foreground max-w-[280px]">Le tue liste d'attesa e transazioni appariranno qui. Inizia cliccando su "Nuovo Pagamento".</p>
            </div>
          ) : (
            <Table>
              <TableHeader>
