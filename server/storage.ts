...
`);
    ...
    const membersList = rows.map((row: any) => ({
      ...
      motherBirthProvince: row.mother_birth_province,
      motherStreetAddress: row.mother_street_address,
      motherCity: row.mother_city,
      motherProvince: row.mother_province,
      motherPostalCode: row.mother_postal_code,
      ...
      fatherBirthProvince: row.father_birth_province,
      fatherStreetAddress: row.father_street_address,
      fatherCity: row.father_city,
      fatherProvince: row.father_province,
      fatherPostalCode: row.father_postal_code,
      ...
      fromWhere: row.from_where,
      teamSegreteria: row.team_segreteria,
      detractionModelRequested: row.detraction_requested,
      detractionModelYear: row.detraction_year,
      schoolCreditsRequested: row.credits_requested,
      schoolCreditsYear: row.credits_year,
      tesserinoTecnicoNumber: row.tesserino_tecnico_number,
      tesserinoTecnicoIssueDate: row.tesserino_tecnico_date,
      active: row.active,
