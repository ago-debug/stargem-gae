...
- Includi una "Call to Action" finale per invitare a prenotare in reception o via app.`;
  ...
  */
  ...
  // ==== Courses Routes ====
  app.get("/api/courses/:id/enrolled-members", isAuthenticated, async (req, res) => {
    try {
    ...
    try {
      ...
      switch (table) {
        ...
        case "courses":
          ...
          break;
        case "workshops":
          rawData = await storage.getActivities(); // getActivities contains workshops etc
          break;
        case "gemteam":
