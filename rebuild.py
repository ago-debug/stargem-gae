...
with open('scratch_ui.tsx', 'w') as f:
    f.write(ui_code)

import os
with open('scratch.tsx', 'r') as root, open('scratch_ui.tsx', 'r') as append:
    content = root.read() + append.read()
    with open('client/src/pages/import-data.tsx', 'w') as final:
        final.write(content)

print("Done stitching TSX")
