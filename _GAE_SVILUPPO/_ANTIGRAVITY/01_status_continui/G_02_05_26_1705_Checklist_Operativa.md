...
> **Ultimo Aggiornamento:** 02 May 2026, 17:05
...
## 7. GemPass & MedGem (Unificazione & Roadmap Futura)
- [x] Unificazione UI in /gempass e migrazione sub-componenti (TabTessereEnte, TabCertificati, TabStampaTessere).
- [ ] **Migrazione MedGem**: Sganciare i Certificati Medici dall'hub GemPass e farli vivere in un futuro modulo indipendente 'MedGem'.
- [ ] Ottimizzare interconnessioni B2C (Area Tesserati) vs Tesseramento Interno.
