...
* **[AG-051] Avvio Rifacimento Dashboard Segreteria:** Autorizzata e schedata la riprogettazione in cantiere per la schermata home del CRM (Segreteria Operativa). I requirements impongono lo sviluppo di un widget dedicato per le "Entrate Mese" diviso puntualmente per operatore (membro team), unito alla totale sostituzione dell'area "Attività Recente" in favore di una più pragmatica "Sezione Scadenze Operative" volta al pinging di alert critici e task in close-out.
