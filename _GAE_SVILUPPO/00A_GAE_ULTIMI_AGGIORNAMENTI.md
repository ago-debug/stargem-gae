...
* **Risoluzione QA HotFixes (Consegna Martedì):** Aggiornata e chiusa interamente la check-list di fix strutturali dell'UX Calendario: Auto-switch ed Etichetta "25-26" confermati in header, zero-overlap card stabilizzato al 100%, dinamicizzazione altezza file espletata per prevenire troncamenti. Duplicazione stagionale stabilizzata ed esaurita per la messa in onda.
