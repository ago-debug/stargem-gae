...
*   **Modali Contestuali (SPA UX):** Eliminati i redirect lenti a vecchie pagine. Introdotta l'apertura "volante" istantanea del modale (es. Nuova Tessera) direttamente cliccando un pulsante cross-pagina (es. "+ Nuova Tessera" in Maschera Generale) o semplicemente cliccando l'intera riga della tabella anagrafica, sfruttando i search params nascosti per saltare direttamente al carrello.
